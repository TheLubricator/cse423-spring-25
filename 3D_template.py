...
def draw_shapes():
    ...
    glRotatef(-90,0, 0, 1)  # Raise arm upwards by 90 degrees

    # The right hand (palm facing upwards)
    glPushMatrix()
    glTranslatef(0, 0, 40)  # Positioning the hand in a palm-up position
    ...
    glRotatef(90, 0, 0, 1)  # Make sword vertical (pointing up)
